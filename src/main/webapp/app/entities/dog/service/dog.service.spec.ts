...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../dog.test-samples';

import { DogService } from './dog.service';

const requireRestSample: IDog = {
...
describe('Dog Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Dog', () => {
      const dog = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(dog).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Dog', () => {
      const dog = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(dog).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addDogToCollectionIfMissing', () => {
      it('should add a Dog to an empty array', () => {
        const dog: IDog = sampleWithRequiredData;
      ...
      it("should add a Dog to an array that doesn't contain it", () => {
        const dog: IDog = sampleWithRequiredData;
        const dogCollection: IDog[] = [sampleWithPartialData];
        expectedResult = service.addDogToCollectionIfMissing(dogCollection, dog);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(dog);
      });
      ...
      it('should add only unique Dog to an array', () => {
        const dogArray: IDog[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const dogCollection: IDog[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const dog: IDog = sampleWithRequiredData;
        const dog2: IDog = sampleWithPartialData;
    ...
    describe('compareDog', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareDog(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareDog(entity1, entity2);
        const compareResult2 = service.compareDog(entity2, entity1);
