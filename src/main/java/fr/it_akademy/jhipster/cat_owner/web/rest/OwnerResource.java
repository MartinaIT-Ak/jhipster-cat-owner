...
/**
 * REST controller for managing {@link fr.it_akademy.jhipster.cat_owner.domain.Owner}.
 */
@RestController
...
public class OwnerResource {
     ...
     */
    @GetMapping("")
    public List<OwnerDTO> getAllOwners(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
